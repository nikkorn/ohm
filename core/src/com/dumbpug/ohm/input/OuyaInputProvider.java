    ...
    public boolean isControlPressed(Control control) {
        ...
        if (Controllers.getControllers().size > 0) {
            ...
            switch (control) {
                ...
                case SECONDARY:
                    return controller.getButton(Ouya.BUTTON_L1);
                case UP:
                    // Whether we are moving up depends on the position of the stick.
                    return leftYAxis < -0.5;
                case DOWN:
                    // Whether we are moving down depends on the position of the stick.
                    return leftYAxis > 0.5;
                case LEFT:
